...
const TIMELINE_EN = {
  ...
  independentImages: "Independent reference images ({count}/30)", independentAudio: "Independent reference audio ({count}/3)",
  ...
  maxImages: "Up to 30 images", maxAudio: "Up to 3 independent audio clips", emptyFile: "The file is empty", tooLarge: "The file exceeds the plug-in's 512 MiB safety limit",
...
function normalizeState(raw) {
  ...
  base.images = Array.isArray(raw.images) ? raw.images.filter(x => x?.file).slice(0, 30).map(a => ({ id:a.id || uid(), ...a })) : [];
...
class TimelineDirectorUI {
  ...
  async addFile(kind,file) {
    ...
    if(kind==="image"&&this.state.images.length>=30){this.setStatus(tr("maxImages"));return;}
